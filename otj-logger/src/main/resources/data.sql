...
ALTER TABLE journal_entries ALTER COLUMN id RESTART WITH 4;
ALTER TABLE timesheets ALTER COLUMN id RESTART WITH 4;
ALTER TABLE journal_entry_ksbs ALTER COLUMN id RESTART WITH 5;
